...
class TA(Teacher, Student):
    ...
    def __str__(self):
        return f"Name: {self.name}, Contact Number: {self.contact}, Department: {self.dep}, Semester: {self.sem}, Course: {self.course}, Office Number: {self.off_num}"

def main():
    person = Person("John ", "123-456-7890")
    print(person)
    print()
